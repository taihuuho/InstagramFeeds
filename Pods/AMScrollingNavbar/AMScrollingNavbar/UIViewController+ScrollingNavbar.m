...
- (void)updateNavbarAlpha:(CGFloat)delta {
    ...
    if (!self.navigationItem.titleView) {
        ...
        NSMutableDictionary *textAttributes = [NSMutableDictionary dictionaryWithDictionary:self.navigationController.navigationBar.titleTextAttributes];
        textAttributes[UITextAttributeTextColor] = [UIColor colorWithRed:red green:green blue:blue alpha:alpha];
